...
function overroom(data){
   ...
   overzt=0;
    ...
    img.onload = function(){
        ...
        ctx.font = "25px bold songti";
        ctx.fillStyle = "#d8cb66";
        ctx.fillText("房间号:"+sj.id, 178,266);
        ctx.fillText(time1, 361, 266);
        ctx.fillText(sj.zjs+"局", 570, 266);
        ...
        ctx.fillText(writeContent,writeLeft,319);
        ...
        for(var i=0;i<sj.user.length;i++){
            ...
            ctx.fillStyle = "#d8cb66";
            ctx.fillText(decode64(user.nickname).substring(0, 9), 225, 384+i*105);
            if(user.dqjf>0){
                user.dqjf='+'+user.dqjf;
            }else{
                ctx.fillStyle = "#fff";
                ctx.fillText(decode64(user.nickname).substring(0, 9), 225, 384+i*105);
                ctx.fillText(user.dqjf, 550, 384-(0-i*105));
            }
            ctx.fillText(user.dqjf, 550, 384-(0-i*105));
        }
