...
function WeChat(url,title,img,desc){
     $.get("/portal/index/getconfig/",{url:window.location.href},function(data) {
        wx.config(data);
        wx.ready(function () {
        // 在这里调用 API
...
function encode64(input)
{
    ...
    $(function(){
        //$("#allgame").on('click',"img",function(){
          setInterval(function(){
            if( $("#setting .selectPart:nth-of-type(3)>.selectList>.selectItem:nth-of-type(1)>.selectText").html().trim().toString()=="五花牛(5倍)"){
                       $("#setting .selectPart:nth-of-type(3)>.selectList>.selectItem:nth-of-type(1)>.selectText").html("五花牛(5倍)")
            
            }else if( $("#setting .selectPart:nth-of-type(3)>.selectList>.selectItem:nth-of-type(1)>.selectText").html().trim().toString()=="五牛花(5倍)"){
                       $("#setting .selectPart:nth-of-type(3)>.selectList>.selectItem:nth-of-type(1)>.selectText").html("五花牛(5倍)")
