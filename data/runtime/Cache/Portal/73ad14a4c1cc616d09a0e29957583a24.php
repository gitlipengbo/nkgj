...
<meta name="full-screen" content="yes">
  ...
  <link rel="stylesheet" href="/app/css/app.css" />
      <link rel="stylesheet" href="/app/hj/static/aui.css">
    <!-- 自定义 -->
    <link rel="stylesheet" href="/app/hj/static/common.css">
    <link rel="stylesheet" href="/app/hj/static/one_black.css">
	<link rel="stylesheet" href="/app/hj/static/index.css">
<link rel="stylesheet" href="/app/hj/static/swiper.min.css">
<script src="/app/hj/static/swiper.min.js"></script>
  <style>
/*	.createB{
 ...
 /*  .createCommit{
  ...
  <script src="/app/js/appp.js" type="text/javascript"></script>
 ...
 <header class="header-user-info">
        ...
        <div class="media-txt" style="max-width:6rem">
            ...
            <p class="media-txt-content">
                <span>
                    <img src="/app/hj/images/currencyicon.png?v=1.0.1" class="diamond-img"><span style="font-size:14px" id="fknum"></span></span>
            </p>
        </div>
    </div>
        <div class="head-right">
                        <!--<a href="javascript:void(0)" id="roomIdInput" class="golden-btn need_login">房号进入</a>-->
						<a href="http://hhyo.seekeyes.com/index.php/portal/user/dashengfangka" style="margin-right:22px" class="golden-btn need_login">房卡发送</a>
                            </div>
</header>
 <section class="slide-wrap top-banner" style="margin-top: 60px;">
    <div style="height:23%" class="banner swiper-container top-swiper swiper-container-horizontal">
        <ul class="swiper-wrapper" style="transform: translate3d(-706px, 0px, 0px); transition-duration: 0ms;"><li class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/app/hj/static/1511256971516917.png" alt="" class="slide-img"></a></li>
                        <li class="swiper-slide swiper-slide-duplicate-active swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/app/hj/static/1511256971516917.png" alt="" class="slide-img"></a></li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-active swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/app/hj/static/1511256971516917.png" alt="" class="slide-img"></a></li></ul>
    </div>
</section>
...
<section class="games-panel">
    <ul class="games-panel-content">
                <li>
                    ...
                    <img src="/app/hj/static/1512638957372590.jpg" alt="六人牛牛">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:2})" class="need_login">
                    <img src="/app/hj/static/1512638976538926.jpg" alt="九人牛牛">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:10})" class="need_login">
                    <img src="/app/hj/static/1512638307231480.jpg" alt="十二人牛牛">
                </a>
                                    </li>
                  <li>
                                            <a onclick="send('gameserver',{id:14})" class="need_login">
                    <img src="/app/hj/static/1512640915210254.jpg" alt="九人八倍牛牛">
                </a>
                 </li>
                <li>
                                            <a onclick="send('gameserver',{id:5})" class="need_login">
                    <img src="/app/hj/static/6renjh.jpg" alt="六人金花">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:16})" class="need_login">
                    <img src="/app/hj/static/9renjh.jpg" alt="九人金花">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:3})" class="need_login">
                    <img src="/app/hj/static/1512729845604014.jpg" alt="六人三公">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:4})" class="need_login">
                    <img src="/app/hj/static/9rensg.jpg" alt="九人三公">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:17})" class="need_login">
                    <img src="/app/hj/static/12rensg.jpg" alt="十二人三公">
                </a>
                                    </li>
                 <li>
                                            <a onclick="send('gameserver',{id:27})" class="need_login">
                    <img src="/app/hj/static/paijiu.jpg" alt="牌九">
                </a>
                                    </li>
                 <li>
                                            <a onclick="send('gameserver',{id:6})" class="need_login">
                    <img src="/app/hj/static/erba.jpg" alt="二八杠">
                </a>
                                    </li>
                 <li>
                                            <a onclick="send('gameserver',{id:26})" class="need_login">
                    <img src="/app/hj/static/yuxia.jpg" alt="鱼虾蟹">
                </a>				
                 </li>-->
                <li><img src="/app/hj/static/healthy_warn.png" alt="健康公告" style="border:0;border-radius:0;"></li>
