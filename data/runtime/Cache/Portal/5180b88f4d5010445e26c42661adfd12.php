...
<div id="networkReconnect" style="position: fixed; width:2.88rem; line-height:.2rem; font-size:.1rem; left:.36rem; text-align: center; bottom:45%; background: -webkit-linear-gradient(left, rgba(0,0,0,0), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0)); background: -moz-linear-gradient(left, rgba(0,0,0,0), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0)); background: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0.5), rgba(0,0,0,0)); color:#fff; display:none; z-index:9999;">
 ...
 $rule_model = M('rule'); $rules = $rule_model->where('type="15" and zt=1')->order('`sort` desc')->select(); ?>
        ...
        <div class="game-list">
            ...
            <div class="game-item niuniu-bg"><button>创建房间</button></div>
            <div class="game-item thirteenoxen-bg"><button>创建房间</button></div>
            <div class="game-item goldflower-bg"><button>创建房间</button></div>
            <div class="game-item texas-poker-bg"><button>创建房间</button></div>
            <div class="game-item three-opens-bg"><button>创建房间</button></div>
            <div class="game-item thirteencard-bg"><button>创建房间</button></div>
            <div class="game-item fillingPitcard-bg"><button>创建房间</button></div>
        </div>
        ...
        <div class="pupop-container niuniuTen-mask">
            <div class="niuniu-opacity">
                <div class="content-box">
                    ...
                    <button class="createRoomBtn" onclick="createRoom()"></button>
                    ...
                    <div class="content-item">
                        <div class="content">
                            ...
                            <div class="flex-cont rules">
                                ...
                                <div class="flex-item">
                                    <label><input name="niuniuThirteen_card_rule" value="1" checked="" type="radio" /><span>牛牛&times;3 牛九&times;2 牛八&times;2</span></label>
                                    <br />
                                    <label><input name="niuniuThirteen_card_rule" value="2" type="radio" /><span>牛牛&times;4 牛九&times;3 牛八&times;2 牛七&times;2</span></label>
                                </div>
                            </div>
                            <div class="flex-cont type">
                                <div class="name">
                            ...
                            <div class="flex-cont innings">
                                ...
                                <div class="flex-item">
                                    <label><input name="niuniuThirteen_max_matches" value="12" checked="" type="radio" /><span>12局<img class="mask-inning-card" src="http://cdn.lfzgame.com/images/index/mask-inning-card.png" />X3</span></label>
                                    <label><input name="niuniuThirteen_max_matches" value="24" type="radio" /><span>24局<img class="mask-inning-card" src="http://cdn.lfzgame.com/images/index/mask-inning-card.png" />X6</span></label>
                                </div>
                            </div>
                            <div class="zhuang"></div>
                        </div>
